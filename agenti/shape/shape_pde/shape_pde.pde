...
int formResolution = 100; // number of points on the curve
int stepSize = 2; // how much distortion it has
float distortionFactor = 1;
float initRadius = 150; // size of the circle
...
void setup(){
  ...
  stroke(0, 10); //stroke transparency
  background(255);
}
...
void draw(){
  ...
  //stroke(random(250),random(250),200,10);
  strokeWeight(0.75);
